      ...
      <div className="home-con">
        ...
        <div className="new-arrivals">
          ...
          <div className="newarrivals-main-section">
            ...
            <div className="newarrivals-main-con" onClick={()=>{navigate('/addtocart')}}>
        ...
        <div className="exclusive">
             ...
             <p>Exclusive Bridal Wear<br/> Sarees</p>
        </div>
        {/* Best sellers */}
        ...
        <div className="happy-customers">
               <div className="happy-customers-sub">
                     ...
                     <p>Wore this lovely red saree with a woollen skivi for a 
                        winter morning function. Looked elegant and is 
                        extremely comfortable to wear.</p>
                        <h2>Archan M.S</h2>
               </div>
                <div className="happy-customers-sub">
                     <img src={ratings} alt="ratings"/>
