...
const Inventory = () => {
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        const requiredFields = ['category', 'itemname', 'price', 'code', 'stitchingOptions', 'fabric', 'washCare', 'length', 'description'];
        ...
        try {
          ...
          await axios.post("https://jk-skills.onrender.com/addItem", formDataToSend, {
            headers: {
