  ...
  return (
    <>
      ...
      <div className="saree-con">
        ...
        <p>
          Soft silk sarees are produced using fine silk fiber and less zari to
          attain its smooth texture. The smooth surface that does not have any
          projected threads makes it convenient to use. They are a harmonious
          blend of delicate silk threads, exuding a luxurious yet gentle
          texture, allowing for seamless draping and a touch of understated
          elegance, perfect for various occasions.
        </p>
