        ...
        <div className="productview-main-con">
          <div className="productview-main-img-con">
            <div className="main-img-con">
              <img
                src={`data:image/png;base64, ${selectedProduct.itemImage1}`}
                alt={`Item ${selectedProduct.itemname}`}
              />
            </div>
            <div className="sub-img-con">
              <div className="sub-img">
                <img
                  src={`data:image/png;base64, ${selectedProduct.itemImage2}`}
                  alt={`Item ${selectedProduct.itemname}`}
                />
              </div>
              <div className="sub-img">
                <img
                  src={`data:image/png;base64, ${selectedProduct.itemImage3}`}
                  alt={`Item ${selectedProduct.itemname}`}
                />
              </div>
              <div className="sub-img">
                <img
                  src={`data:image/png;base64, ${selectedProduct.itemImage4}`}
                  alt={`Item ${selectedProduct.itemname}`}
                />
              </div>
            </div>
