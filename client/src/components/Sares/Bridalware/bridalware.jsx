    ...
    axios
      ...
      .then((response) => {
        ...
        const freshVegetables = data.items.filter(
          (item) => item.category === "exclusiveBridalWear"
        );
  ...
  return (
    <>
      ...
      <div className="saree-con">
        ...
        <p>
          Bridal wear sarees are opulent ensembles adorned with intricate
          embellishments, rich fabrics, and exquisite designs, meticulously
          crafted to exude timeless grace and elevate the bride's beauty on her
          special day, epitomizing tradition and splendor.
        </p>
