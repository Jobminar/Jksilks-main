    ...
    axios
      ...
      .then((response) => {
        ...
        const freshVegetables = data.items.filter(
          (item) => item.category === "pureKanjivaramSilk"
        );
  ...
  return (
    <>
      ...
      <div className="saree-con">
        ...
        <p>
          Silk sarees comes with a traditional value that is displayed through
          its craftsmanship. A traditional pattu saree is weaved using pure
          mulberry silk and a gold zari. Each saree is made with three threads
          of mulberry silk.
        </p>
