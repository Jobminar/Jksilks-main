  ...
  useEffect(() => {
    ...
    axios.get(apiUrl)
      .then(response => {
        ...
        console.log(data)
        const freshVegetables = data.items.filter(item => item.category === 'pureKanjivaramSilk');
    ...
    <>
     {/* <p>Inventory Data</p>
      ...
      <div className='saree-con'>
        ...
        <h1 className='head'>Pure Kanjivaram silk</h1>
        <p>Silk sarees comes with a traditional value that is displayed through its craftsmanship. A traditional pattu saree is weaved using pure mulberry silk and a gold zari. Each saree is made with three threads of mulberry silk.</p>
